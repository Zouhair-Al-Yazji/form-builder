                ...
                >
                  ...
                  <div className="col-span-2 flex flex-col gap-1">
                    ...
                    <div className="bg-[#242424]/50 rounded grid grid-cols-3">
                      <button
                        type="button"
                        className={`p-2 cursor-pointer text-sm font-medium ${watch("width") === "full" ? "bg-[#242424]/95" : ""}`}
                      ...
                      <button
                        type="button"
                        className={`p-2 cursor-pointer text-sm font-medium ${watch("width") === "half" ? "bg-[#242424]/95" : ""}`}
                      ...
                      <button
                        type="button"
                        className={`p-2 cursor-pointer text-sm font-medium ${watch("width") === "third" ? "bg-[#242424]/95" : ""}`}
                        onClick={() => setValue("width", "third")}
                      >
                        Third Width
                      </button>
                    </div>
